// =====================================================
// TIS TIS PLATFORM - Voice Agent Icons
// Iconos centralizados para el módulo de Voice Agent
// =====================================================
...
export const PhoneIncomingIcon = ({ className, ...props }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const PhoneOutgoingIcon = ({ className, ...props }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const PhoneOffIcon = ({ className, ...props }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Volume2Icon = ({ className, ...props }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/>
...
// Alias for backward compatibility
export const AlertIcon = AlertCircleIcon;
...
export const HashIcon = ({ className, ...props }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export default VoiceAgentIcons;
