...
const CONNECTOR_CATALOG: ConnectorDefinition[] = [
  ...
  },
  {
    type: 'freshsales',
    name: 'Freshsales',
    description: 'CRM con automatización de ventas de Freshworks',
    icon: 'freshsales',
    category: 'crm',
    auth_type: 'oauth2',
    supports_oauth: true,
  ...
  },
  {
    type: 'dentalink',
    name: 'Dentalink',
    description: 'Software dental líder en Latinoamérica',
    icon: 'dentalink',
    category: 'dental',
    auth_type: 'api_key',
    supports_oauth: false,
  ...
  },
  {
    ...
    description: 'Programación de citas y gestión de clientes',
    icon: 'acuity',
    category: 'calendar',
    auth_type: 'oauth2',
    supports_oauth: true,
  ...
  return (
    <div className="bg-white dark:bg-[#2a2a2a] rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
      ...
      <div className="px-5 py-4 bg-gray-50/50 dark:bg-[#222] border-t border-gray-100 dark:border-gray-700">
        {isConfiguring ? (
          /* Configuring state - single button full width */
          <button
            onClick={onConfigure}
            disabled={isLoading}
            className={cn(
