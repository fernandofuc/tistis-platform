      ...
      <div className="flex min-h-full items-center justify-center p-2 sm:p-4">
        <div
          className={cn(
            ...
            'transform transition-all max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)] overflow-y-auto',
            sizeClasses[size]
          )}
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          {/* Footer */}
          {footer && (
            <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3 p-4 sm:p-5 border-t border-gray-100 bg-gray-50 rounded-b-xl">
              {footer}
            </div>
          )}
        </div>
