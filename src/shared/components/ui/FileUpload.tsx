    ...
    <div className={cn('w-full', className)}>
      ...
      <div
        ...
        className={cn(
          ...
          'flex flex-col items-center justify-center min-h-[120px] sm:min-h-[150px]',
          isDragActive
      ...
      {selectedFiles.length > 0 && !isUploading && (
        <div className="mt-3 sm:mt-4 space-y-2">
          {selectedFiles.map((file, index) => (
            ...
            >
              ...
              <button
                ...
                className="p-2 sm:p-1.5 text-gray-400 hover:text-red-500 transition-colors min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0 flex items-center justify-center"
              >
          ...
          <button
            ...
            disabled={disabled || isUploading}
            className={cn(
              'w-full py-3 sm:py-2.5 px-4 rounded-lg font-medium text-white transition-colors min-h-[48px] sm:min-h-0',
