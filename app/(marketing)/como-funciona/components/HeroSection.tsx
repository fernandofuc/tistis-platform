    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-card border border-slate-100">
            ...
            <span className="text-sm font-medium text-slate-700">
              Potenciado por GPT-5 + Gemini + Claude AI
            </span>
          </div>
        </div>
        ...
        <h1 className="text-center text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tight mb-6">
          ...
          <br />
          y trabaja por ti 24/7
        </h1>

        {/* Subtitle */}
        <p className="text-center text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
          TIS TIS no es un chatbot generico. Es un sistema de agentes inteligentes que
          responde WhatsApp, agenda citas, califica leads y genera facturas mientras duermes.
          <span className="block mt-2 text-tis-coral font-medium">
            Sin perder un solo cliente. Sin contratar mas personal.
          </span>
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-10">
          <div className="flex items-center gap-2 text-slate-600">
            ...
            <span className="text-sm font-medium">Respuesta en segundos, no horas</span>
          </div>
          <div className="flex items-center gap-2 text-slate-600">
            <div className="w-2 h-2 bg-tis-green rounded-full" />
            <span className="text-sm font-medium">Ahorra +20 horas semanales</span>
          </div>
          <div className="flex items-center gap-2 text-slate-600">
            <div className="w-2 h-2 bg-tis-green rounded-full" />
            <span className="text-sm font-medium">0 leads perdidos por no contestar</span>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-col items-center">
          <p className="text-sm text-slate-500 mb-4">Integracion nativa con los canales que tus clientes ya usan</p>
          <div className="flex items-center gap-8 opacity-70">
            {/* WhatsApp */}
            <div className="flex flex-col items-center gap-1">
              <svg className="h-7 w-auto" viewBox="0 0 24 24" fill="#25D366">
            ...
            {/* Instagram */}
            <div className="flex flex-col items-center gap-1">
              <svg className="h-7 w-auto" viewBox="0 0 24 24" fill="#E4405F">
            ...
            {/* Facebook */}
            <div className="flex flex-col items-center gap-1">
              <svg className="h-7 w-auto" viewBox="0 0 24 24" fill="#1877F2">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span className="text-xs text-slate-500">Messenger</span>
            </div>
            {/* TikTok */}
            <div className="flex flex-col items-center gap-1">
            ...
            {/* Voice AI */}
            <div className="flex flex-col items-center gap-1">
              <svg className="h-7 w-auto" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/>
                <path d="M19 10v2a7 7 0 0 1-14 0v-2"/>
                <line x1="12" y1="19" x2="12" y2="23"/>
                <line x1="8" y1="23" x2="16" y2="23"/>
              </svg>
              <span className="text-xs text-slate-500">Llamadas IA</span>
            </div>
          </div>
        </div>
      </div>
