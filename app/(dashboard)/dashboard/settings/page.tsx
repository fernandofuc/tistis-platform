            ...
            <CardContent className="p-0">
              <nav className="p-2">
                {tabs.map((tab) => (
                  ...
                  >
                    <span className={cn(activeTab === tab.key && 'text-tis-coral')}>
                      {tab.icon}
                    </span>
          ...
          {activeTab === 'profile' && (
            <Card variant="bordered">
              ...
              <CardContent>
                ...
                {/* No Staff Record Warning - with auto-retry */}
                {!staff && user && (
                  <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-center justify-between text-amber-700">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                      </svg>
                      <span className="text-sm font-medium">Configurando tu perfil de staff...</span>
                    </div>
                    <Button
                      variant="outline"
                      size="sm"
                      ...
                      <div className="space-y-3 bg-gray-50 rounded-xl p-4">
                        ...
                        <div className="flex items-center justify-between py-3 px-2 bg-white rounded-lg gap-3">
                          ...
                          <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                            ...
                            />
                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600"></div>
                          </label>
                        </div>
