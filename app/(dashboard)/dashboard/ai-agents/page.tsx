...
// =====================================================
// TIS TIS PLATFORM - Mis Agentes de IA Page
// Página unificada para configurar agentes de IA
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold mb-2">Mis Agentes de IA</h1>
              <p className="text-white/80 text-sm leading-relaxed max-w-xl">
                Configura tus asistentes virtuales para responder automáticamente por mensajería y voz.
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/dashboard/settings?tab=ai-agent"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title="Conversaciones hoy" value="124" trend="+12%" />
          <StatCard title="Leads capturados" value="28" trend="+5%" />
          <StatCard title="Citas agendadas" value="15" />
          <StatCard title="Satisfacción" value="4.8" icon="star" />
        </div>
        */}
      </div>
